...
const photos = [
  { name: "eyes", src: "/images/about/eyes.jpg", alt: "Sarah in warm window light", width: 2708, height: 3488 },
  { name: "boots", src: "/images/about/boots.jpg", alt: "Black boots held up against the beach at sunset", width: 1496, height: 1260 },
  { name: "looksz", src: "/images/about/looksz.jpg", alt: "A quiet moment seen through a mirror", width: 1424, height: 1300 },
  { name: "sarah", src: "/images/about/sarah.jpg", alt: "Sarah outdoors", width: 2220, height: 2960 },
  { name: "shadow", src: "/images/about/shadow.jpg", alt: "A long shadow in the landscape", width: 2294, height: 3325 },
  { name: "mirror", src: "/images/about/mirror-photo.jpg", alt: "A reflection in a mirror", width: 905, height: 1203 },
  { name: "lili", src: "/images/about/lili-and-me.jpg", alt: "Lili and Sarah together", width: 3487, height: 4640 },
] as const;
